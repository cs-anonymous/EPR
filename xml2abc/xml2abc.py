...
class Parser:
    ...
    def ntAbc (s, ptc, oct, note, v, ntrec, isTab): # pitch, octave -> abc notation
        acc2alt = {'double-flat':-2,'flat-flat':-2,'flat':-1,'natural':0,'sharp':1,'sharp-sharp':2,'double-sharp':2,
                   'natural-flat':-1,'natural-sharp':1,'quarter-flat':-1,'quarter-sharp':1,
                   'three-quarters-flat':-2,'three-quarters-sharp':2,'slash-flat':-1,'slash-sharp':1,
                   'flat-1':-1,'flat-2':-1,'flat-3':-1,'flat-4':-1,'flat-5':-1,
                   'sharp-1':1,'sharp-2':1,'sharp-3':1,'sharp-5':1,
                   'sori':0,'koron':0,'other':0}
        ...
        if acc == None and alt == None: return p    # no acc, no alt
            ...
            alt = acc2alt.get (acc, 0)      # acc takes precedence over the pitch here!
