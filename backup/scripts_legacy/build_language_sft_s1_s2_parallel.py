...
This generator:
1. Reads paired train rows from data/metadata.csv.
2. Reads unpaired score train rows from data/unpaired_metadata.csv.
...
def main():
    ...
    parser.add_argument("--unpaired-metadata", type=Path, default=Path("data/unpaired_metadata.csv"))
