...
def main() -> None:
    ...
    parser.add_argument("--base-dir", type=Path, default=Path("backup/legacy_CoReS/language_cpt"))
    parser.add_argument("--metadata", type=Path, default=Path("sft_data/core-s-train/metadata_train.csv"))
    parser.add_argument("--out-root", type=Path, default=Path("backup/legacy_CoReS"))
    ...
    parser.add_argument("--work-dir", type=Path, default=Path("data/.tmp_language_cpt_subsets"))
