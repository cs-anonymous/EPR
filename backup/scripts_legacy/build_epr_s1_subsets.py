...
Outputs:
  - backup/legacy_Corpora/measure_epr_s1.jsonl
  - backup/legacy_Corpora/phrase_epr_s1.jsonl
"""
...
TASK_CONFIGS = {
    "measure_epr": {
        "ratio": 0.30,
        "max_length": 768,
        "input_dir": Path("backup/legacy_Corpora/measure_epr_sft"),
        "output_path": Path("backup/legacy_Corpora/epr_sft/measure_epr_s1.jsonl"),
    ...
    "phrase_epr": {
        "ratio": 0.50,
        "max_length": 1536,
        "input_dir": Path("backup/legacy_Corpora/phrase_epr_sft"),
        "output_path": Path("backup/legacy_Corpora/epr_sft/phrase_epr_s1.jsonl"),
    ...
    "abcx2pm": {
        "ratio": 0.50,
        "max_length": 1536,
        "input_dir": Path("backup/legacy_Corpora/abcx2pm_sft"),
        "output_path": Path("backup/legacy_Corpora/epr_sft/abcx2pm_s1.jsonl"),
    ...
    "sm2pm": {
        "ratio": 0.50,
        "max_length": 1536,
        "input_dir": Path("backup/legacy_Corpora/sm2pm_sft"),
        "output_path": Path("backup/legacy_Corpora/epr_sft/sm2pm_s1.jsonl"),
        "target_field": "target_start_measure_id",
