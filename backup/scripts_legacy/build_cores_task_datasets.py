#!/usr/bin/env python3
"""Build task-specific CoRe-S train datasets under backup/legacy_CoReS.
...
def write_stats(out_root: Path, stats: list[dict]) -> None:
    ...
    lines = [
        ...
        "",
        "Generated from `sft_data/core-s-train` and `data/knowledge`.",
        "",
        "## Families",
        "",
