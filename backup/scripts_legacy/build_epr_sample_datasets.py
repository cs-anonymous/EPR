...
backup/legacy_CoReS/{measure,phrase}_epr_sft only after all outputs are complete.
"""
...
def main() -> None:
    ...
    parser.add_argument("--work-dir", type=Path, default=Path("data/.tmp_cores_epr_sample"))
