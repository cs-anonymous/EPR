#!/usr/bin/env python3
"""Build a single-file CPT-S1 JSONL mix from data language corpora.
...
def main() -> None:
    ...
    parser.add_argument(
        "--source-dir",
        type=Path,
        default=Path("backup/legacy_Corpora/language_cpt"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("backup/legacy_Corpora/language_cpt/language_cpt_s1.jsonl"),
    )
    parser.add_argument(
        "--summary",
        type=Path,
        default=Path("backup/legacy_Corpora/language_cpt/language_cpt_s1.summary.json"),
    )
    parser.add_argument(
        "--shuffled-output",
        type=Path,
