...
def main():
    ...
    parser.add_argument("--s1-dir", type=Path, default=Path("backup/legacy_CoReS/language_sft_s1"))
    parser.add_argument("--s2-dir", type=Path, default=Path("backup/legacy_CoReS/language_sft_s2"))
    parser.add_argument("--output", type=Path, default=Path("backup/legacy_CoReS/language_sft_merged_shuffled.jsonl"))
