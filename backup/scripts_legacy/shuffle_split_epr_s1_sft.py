...
TASKS = {
    "measure_epr": {
        "input": Path("backup/legacy_Corpora/epr_sft/measure_epr_s1.jsonl"),
        "train_output": Path("backup/legacy_Corpora/epr_sft/measure_epr_s1_shuffle_train.jsonl"),
        "val_output": Path("backup/legacy_Corpora/epr_sft/measure_epr_s1_shuffle_val.jsonl"),
        "val_size": 10_000,
    },
    "phrase_epr": {
        "input": Path("backup/legacy_Corpora/epr_sft/phrase_epr_s1.jsonl"),
        "train_output": Path("backup/legacy_Corpora/epr_sft/phrase_epr_s1_shuffle_train.jsonl"),
        "val_output": Path("backup/legacy_Corpora/epr_sft/phrase_epr_s1_shuffle_val.jsonl"),
        "val_size": 5_000,
    },
    "abcx2pm": {
        "input": Path("backup/legacy_Corpora/epr_sft/abcx2pm_s1.jsonl"),
        "train_output": Path("backup/legacy_Corpora/epr_sft/abcx2pm_s1_shuffle_train.jsonl"),
        "val_output": Path("backup/legacy_Corpora/epr_sft/abcx2pm_s1_shuffle_val.jsonl"),
        "val_size": 5_000,
    },
    "sm2pm": {
        "input": Path("backup/legacy_Corpora/epr_sft/sm2pm_s1.jsonl"),
        "train_output": Path("backup/legacy_Corpora/epr_sft/sm2pm_s1_shuffle_train.jsonl"),
        "val_output": Path("backup/legacy_Corpora/epr_sft/sm2pm_s1_shuffle_val.jsonl"),
        "val_size": 5_000,
    },
}
...
def main() -> None:
    ...
    parser.add_argument(
        "--summary",
        type=Path,
        default=Path("backup/legacy_Corpora/epr_sft/epr_s1_shuffle_sft_summary.json"),
    )
