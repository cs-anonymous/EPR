#!/usr/bin/env python3
"""Shuffle epr_S raw and split into shuffled + train rounds 1/2/3."""
...
def main():
    ...
    raw_path = Path("data/CorporaV2/sft/epr_S_4096_raw.jsonl")
    ...
    shuffled_path = output_dir / "epr_S_4096_shuffled.jsonl"
    ...
    rounds_dir = output_dir / "sft_rounds_S"
    rounds_dir.mkdir(parents=True, exist_ok=True)

    summary = {}

    for name, part in split_evenly(train_records, 3, "train_S"):
