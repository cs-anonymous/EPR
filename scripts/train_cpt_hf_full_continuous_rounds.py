#!/usr/bin/env python3
"""Train full-parameter language CPT across multiple rounds without reloading."""
...
from train_cpt_hf_full import CausalLMTextCollator, save_manifest
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--rounds",
        nargs="+",
        default=["train_S1", "train_S2", "train_Astar1", "train_Astar2", "train_Astar3"],
    )
